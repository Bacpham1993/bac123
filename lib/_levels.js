            ...
            switch(gl.level.currentLevel){
                ...
                case "2":
                    ...
                    if(!t.level2.showed){
                        ...
                        t.gContext.fillText("Hãy dùng Urgo Start Plus để tiêu diệt MMPs càng nhiều nhé",settings.width/2-150,settings.height/2-20);
                    }
                ...
                case "3":
                    t.opponents[0].draw();
                //     // if(!t.level3.showed && t.opponents[i].y >= 0){
                //     //     t.level3.show = true;
                //     // }
                //    if(!t.level3.show) {
                //         t.gContext.font = "20px Arial";
                //         t.gContext.fillStyle = "#fff"
                //         t.gContext.fillText("Hãy tiêu diệt mạch máu xấu nhé!",settings.width/2-150,settings.height/2-20);
                //    }                               
