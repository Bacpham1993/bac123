...
//startscreen
gl.getDom("startGameBtn").addEventListener("click",function(){
    gl.show(gl.gameScreen,this.parentNode.parentNode);
    gl.start = true;
})
...
gl.getDom("animated_background").addEventListener("click",function(){
    ...
    val == 0 ? (gl.getDom("animated_background").value=1):(gl.getDom("animated_background").value=0)
