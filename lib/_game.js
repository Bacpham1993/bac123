function _game(){
    ...
    t.gameLoop = function(e){
        window.requestAnimationFrame(t.gameLoop);
        if(gl.start){
            gl.restartPanel.style.display = "none"
        ...
        t.animateBackground();
        t.bContext.globalAlpha = 0.5;
        t.bContext.drawImage(gl['background'], 0, t.bgY, t.fCanvas.width, t.fCanvas.height)
        t.bContext.restore();      
